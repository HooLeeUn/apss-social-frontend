...
const copy = {
  es: {
    feed: ["¡Bienvenido a ReCCool!", "Te mostraremos rápidamente las principales funciones del Feed para que puedas empezar a explorar la plataforma.", "¡Ya conoces el Feed!", "Ahora tienes las herramientas principales para comenzar a explorar ReCCool."],
    profile_feed: ["Este es tu Profile Feed", "Aquí puedes administrar tu perfil y consultar tu actividad, conexiones, calificaciones, listas y recomendaciones.", "¡Tu Profile Feed está listo!", "Ya conoces las principales herramientas para administrar tu actividad y conexiones en ReCCool."],
    detail_movie: ["Conoce el detalle de una producción", "Aquí puedes explorar información sobre una película o serie e interactuar con ella y con otros usuarios de ReCCool.", "¡Ya conoces Detail Movie!", "Ahora puedes explorar, calificar y comentar producciones, compartir Video reacciones e interactuar con otros usuarios."],
  },
  en: {
    feed: ["Welcome to ReCCool!", "We'll quickly show you the main features of the Feed so you can start exploring the platform.", "You know the Feed!", "You now have the main tools you need to start exploring ReCCool."],
    profile_feed: ["This is your Profile Feed", "Here you can manage your profile and view your activity, connections, ratings, lists and recommendations.", "Your Profile Feed is ready!", "You now know the main tools for managing your activity and connections on ReCCool."],
    detail_movie: ["Explore a production", "Here you can explore information about a movie or series and interact with it and other ReCCool users.", "You know Detail Movie!", "You can now explore, rate and comment on productions, share Video Reactions and interact with other users."],
  },
} as const;

const stepCopy = {
  es: {
    feed: [["Busca lo que quieres ver","Encuentra películas y series utilizando el buscador."],["Explora por género","Selecciona hasta tres géneros para personalizar las producciones que aparecen en el Feed."],["Tu perfil personal","Desde aquí puedes acceder a tu Perfil personal, donde encontrarás tu actividad, calificaciones, listas, recomendaciones y otras opciones de tu perfil."],["Tus notificaciones","Aquí recibirás avisos sobre interacciones y actividad relacionada contigo."],["Menú de ReCCool","Desde aquí puedes acceder a las diferentes opciones de la plataforma."],["Conoce las producciones","Cada tarjeta contiene información y acciones para descubrir, guardar, recomendar y calificar películas y series."],["Conoce más sobre una producción","Haz clic en el póster o en el nombre para abrir el detalle de la producción."],["Consulta la sinopsis","Utiliza esta opción para conocer rápidamente de qué trata la producción."],["Guarda y recomienda","Guárdala para después\nUsa la etiqueta para agregar una producción a Mi Lista y recordar que quieres verla.\n\nRecomiéndala\nUsa el ticket para agregar esta producción a Mis Recomendadas."],["Compara las calificaciones","Calificación general\nConsulta la valoración general de la producción. Puedes conocer más sobre nuestro sistema de calificación en Políticas y términos.\n\nCalificación de seguidos\nMuestra la calificación promedio otorgada a esta producción por los usuarios que sigues.\n\nTu calificación\nAquí puedes consultar y asignar tu propia calificación a la película o serie, la cual hará parte del promedio en Calificación general."]],
    profile_feed: [["Tu perfil","Aquí encontrarás la información principal de tu perfil. Haz clic en tu avatar para consultar o actualizar tus datos personales."],["Tus producciones favoritas","Aquí puedes seleccionar y dar a conocer tus tres producciones favoritas +"],["Tus conexiones","Consulta los usuarios que sigues y tus amigos. Desde aquí puedes explorar sus perfiles y mantenerte conectado con su actividad."],["Mi Actividad","Consulta en orden cronológico tus principales acciones e interacciones dentro de ReCCool."],["Buzón privado","Aquí puedes consultar los mensajes privados que has intercambiado con tus Amigos a través de Comentarios dirigidos."],["Mis Calificaciones","Consulta las películas y series que has calificado."],["Mi Lista","Aquí encontrarás las producciones que guardaste con la etiqueta 🏷️ para recordar que quieres verlas."],["Mis Recomendadas","Aquí encontrarás las películas y series que marcaste con el ticket 🎟️ porque quieres recomendarlas a otros usuarios."],["Actividad de tus seguidos","Consulta la actividad reciente de los usuarios que sigues y descubre qué están viendo, calificando, comentando o recomendando." ]],
