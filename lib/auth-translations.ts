...
export const authTranslations = {
  es: {
    ...
    termsPrefix: "He leído y acepto las", termsLink: "Políticas y Términos de RecCool", termsSuffix: ", incluidas las reglas sobre contenido generado por usuarios y moderación.", termsRequired: "Debes aceptar las Políticas y Términos para continuar.", termsVersionError: "No se pudo validar la versión de los términos.",
  ...
  en: {
    ...
    termsPrefix: "I have read and accept RecCool’s", termsLink: "Policies and Terms", termsSuffix: ", including the rules on user-generated content and moderation.", termsRequired: "You must accept the Policies and Terms to continue.", termsVersionError: "The terms version could not be validated.",
