...
const translations = {
  es: {
    ...
    movieDetailFriendSearchError: "No pudimos buscar amigos en este momento.",
    ...
    movieDetailDirectedMessageRestricted: "No puedes enviar un mensaje dirigido a este usuario.",
  ...
  en: {
    ...
    movieDetailFriendSearchError: "We couldn’t search friends right now.",
    ...
    movieDetailDirectedMessageRestricted: "You cannot send a directed message to this user.",
