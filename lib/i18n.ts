...
const translations = {
  es: {
    ...
    guestSignIn: "Inicia sesión",
    guestSeeMore: "Para ver más regístrate",
    guestRate: "Para calificar regístrate",
    guestSeeMorePrefix: "Para ver más",
    guestRatePrefix: "Para calificar",
    guestListPrefix: "Para listar",
    guestRecommendPrefix: "Para Recomendar,",
    guestExpandPrefix: "Para ver ampliado",
    guestSignupPrefix: "",
    guestProfilePrefix: "Para ver tu perfil",
    guestExploreProfilePrefix: "Para explorar tu perfil",
    guestProfileLoginPrefix: "Para ver tu perfil,",
    guestExploreProfileLoginPrefix: "Para explorar tu perfil,",
    guestNotificationsPrefix: "Para recibir notificaciones",
    guestAvailabilityPrefix: "Para ver disponibilidad en tu país,",
    chooseGenres: "*Escoge hasta 3 géneros",
    weeklyRecs: "Recomendaciones de la semana",
    yourWatchlist: "Tu Cartelera",
    following: "Seguidos",
    myRating: "Mi Calif.",
    ratingPopoverTitle: "Calificar Producción",
    ratingPopoverLabel: "Tu calificación",
    noPoster: "Sin poster",
    ...
    notificationReplyPlaceholder: "Responder a {username}…",
    notificationReplyButton: "Responder",
    notificationReplySending: "Enviando…",
    notificationReplySent: "Respuesta enviada",
    notificationReplyError: "No se pudo enviar la respuesta.",
    trailerWatch: "Ver trailer",
    trailerTitle: "Trailer",
    trailerLoading: "Cargando trailer...",
    ...
    trailerExternalOnly: "Este trailer solo está disponible en YouTube",
    trailerClose: "Cerrar",
    ...
    movieDetailSeriesCommentTitle: "Comentar serie",
    movieDetailVideoCommentTitle: "Video reacción",
    movieDetailVideoCountSingular: "video",
    movieDetailVideoCountPlural: "videos",
    movieDetailTrailerCompanionEmpty: "Agrega tu opinión para interactuar sobre esta producción",
    movieDetailVideoRecord: "Grabar",
    movieDetailVideoUpload: "Cargar video",
    movieDetailVideoCancel: "Cancelar",
    movieDetailVideoStop: "Detener",
    movieDetailVideoRetake: "Repetir",
    movieDetailVideoSend: "Enviar",
    movieDetailVideoRecording: "Grabando",
    movieDetailVideoRotatePortrait: "Gira tu teléfono a posición vertical para continuar grabando.",
    movieDetailVideoUploading: "Cargando",
    movieDetailVideoRequestingPermission: "Solicitando permisos…",
    movieDetailVideoPermissionDenied: "Permiso denegado",
    movieDetailVideoCameraUnavailable: "Cámara no disponible",
    movieDetailVideoMicrophoneUnavailable: "Micrófono no disponible",
    movieDetailVideoUnsupportedBrowser: "Navegador no compatible",
    movieDetailVideoInsecureContext: "Se necesita HTTPS para grabar video",
    movieDetailVideoCameraBusy: "Cámara ocupada",
    movieDetailVideoUnknownError: "Error desconocido",
    movieDetailVideoTooLong: "Video demasiado largo",
    movieDetailVideoTooLarge: "Video demasiado grande",
    movieDetailVideoUnsupportedFormat: "Formato no compatible",
    movieDetailVideoEmpty: "No hay video comentarios todavía.",
    movieDetailVideoLoadingVideos: "Cargando videos…",
    movieDetailVideoLoadError: "No se pudieron cargar los videos.",
    movieDetailVideoReactionError: "No se pudo actualizar tu reacción.",
    movieDetailVideoRetry: "Reintentar",
    movieDetailVideoDelete: "Eliminar video",
    movieDetailVideoPlay: "Reproducir",
    movieDetailVideoPause: "Pausar",
    movieDetailVideoSoundOn: "Activar sonido",
    movieDetailVideoMute: "Silenciar",
    movieDetailVideoRestart: "Reiniciar",
    movieDetailVideoFullScreen: "Pantalla completa",
    movieDetailVideoExpand: "Ampliar video",
    movieDetailVideoCloseExpanded: "Cerrar",
    movieDetailVideoExpandedFeed: "Videos ampliados",
    movieDetailVideoDeleteConfirm: "¿Quieres eliminar este video?",
    movieDetailVideoDeleteAction: "Eliminar",
    movieDetailVideoDeleteError: "No se pudo eliminar el video.",
    movieDetailVideoAuthError: "Debes iniciar sesión para enviar el video",
    movieDetailVideoNetworkError: "No se pudo enviar el video",
    movieDetailVideoServerError: "Error del servidor",
    movieDetailVideoPermissionInfo: "QNext requiere permisos para que puedas grabar tus videos.",
    movieDetailVideoContinue: "Continuar",
    movieDetailVideoCameraOpenError: "No se pudo abrir la cámara.",
    movieDetailVideoPreviewPlaybackError: "No se pudo reproducir la previsualización.",
    movieDetailVideoSelectedReadError: "No se pudo leer el video seleccionado.",
    movieDetailVideoLongerThan20Seconds: "El video supera los 20 segundos.",
    movieDetailVideoFileTooLarge50Mb: "El video supera los 50 MB.",
    movieDetailVideoCameraAccessError: "No se pudo acceder a la cámara y al micrófono.",
    movieDetailVideoRecorderStartError: "No se pudo iniciar la grabación.",
    movieDetailVideoCameraPreviewError: "No se pudo mostrar la cámara.",
    movieDetailVideoPreparingCamera: "Preparando cámara…",
    movieDetailVideoReadingSelectedFile: "Leyendo video…",
    movieDetailVideoRecordedCreateError: "No se pudo generar el video grabado. Inténtalo de nuevo.",
    movieDetailVideoPreparingPreview: "Preparando previsualización…",
    movieDetailVideoPreviewTimeout: "No fue posible preparar la previsualización del video.",
    ...
    movieDetailPublicCommentCountSingular: "comentario",
    movieDetailPublicCommentCountPlural: "comentarios",
    ...
    movieDetailSearchUser: "Buscar usuario",
    movieDetailHasComments: "Con comentarios",
    movieDetailHasConversation: "Con conversación",
    movieDetailNoComments: "Sin comentarios",
    movieDetailAll: "Todos",
    movieDetailNoDirectedComments: "No hay comentarios dirigidos para esta película.",
    movieDetailNoDirectedCommentsWithUser: "No hay comentarios dirigidos con este usuario.",
    movieDetailNoConversationMessages: "No hay mensajes en esta conversación.",
    movieDetailDirectReplyPlaceholder: "Escribe un mensaje...",
    ...
    movieDetailMyProfileAvatarLabel: "Ir a mi perfil",
    profileFeedUser: "Usuario",
    profileFeedPersonalDataAvatarLink: "Ir a datos personales",
    profileFeedAge: "{age} Años",
    profileFeedFavoriteMovies: "Mis Producciones Favoritas",
    ...
    profileFeedFollowingAndFriends: "Seguidos/Amigos",
    profileFeedFollowedByOne: "Tiene 1 seguidor",
    profileFeedFollowedByMany: "Tiene {count} seguidores",
    profileFeedFollowedByYouOne: "Te sigue 1 usuario",
    profileFeedFollowedByYouMany: "Te siguen {count} usuarios",
    ...
    profileFeedRecordings: "Recados",
    profileFeedNoRecordings: "Aún no hay recados de tus seguidos.",
    profileFeedFollowingActivityTitle: "Actividad de Seguidos",
    profileFeedQuickNavigation: "Navegación rápida del perfil",
    emptyFollowingTitle: "Aún no sigues a ningún usuario.",
    emptyFollowingDescription: "Busca y guarda aquí perfiles públicos de usuarios con gustos similares a los tuyos. Podrás consultar sus recomendaciones, comentarios públicos, calificaciones y reacciones, y descubrir producciones que probablemente te encantarán.",
    emptyFriendsTitle: "Aún no tienes amigos agregados.",
    emptyFriendsDescription: "Agrega amigos aquí. Aunque no los sigas, podrás consultar su actividad visitando su perfil. También puedes enviarles mensajes directos mencionándolos con @usuario dentro de la película o serie que quieras comentar.",
    emptyMyActivityTitle: "Aún no tienes actividad registrada.",
    emptyMyActivityDescription: "Recuerda tus interacciones anteriores: tus comentarios públicos sobre películas o series y tus reacciones a comentarios de otros usuarios.",
    emptyInboxTitle: "¿Aún sin mensajes?",
    emptyInboxDescription: "Consulta aquí tus mensajes directos enviados y recibidos, junto con la película o serie en la que se originaron.",
    emptyRatingsTitle: "Aún no tienes producciones calificadas.",
    emptyRatingsDescription: "Aquí podrás recordar qué calificaciones has dado a películas o series y volver a cada producción para actualizar tu calificación cuando quieras.",
    emptyMyListTitle: "Sin producciones por ver.",
    emptyMyListDescription: "Agrega las películas o series que tengas pendientes. Solo tú puedes ver esta lista. Haz clic en la etiqueta 🏷️ para guardarla y no olvidarla. Cuando ya la hayas visto, elimínala de la lista, a menos que quieras repetirla 😉.",
    emptyMyRecommendationsTitle: "Sin producciones por recomendar.",
    emptyMyRecommendationsDescription: "Agrega a esta lista películas o series que te hayan encantado dando clic al ticket 🎟️. Las personas que te siguen y tus amigos podrán ver por qué las recomiendas.",
    emptyFollowingRecommendationsDescription: "Cuando las personas que sigues —solo las que sigues— recomienden películas o series, no te preocupes: aquí te enterarás.",
    emptyFollowingActionsDescription: "Cuando las personas que sigues —solo las que sigues— tengan interacciones públicas, también podrás verlas aquí.",
    ...
    visitedProfileVideoReactions: "Video reacciones",
    visitedProfileNoVideoReactions: "Este usuario aún no ha compartido video reacciones.",
    visitedProfileVideoReactionsError: "No se pudieron cargar las video reacciones de este usuario.",
    visitedProfilePreviousVideoReaction: "Video reacción anterior",
    visitedProfileNextVideoReaction: "Siguiente video reacción",
    ...
    visitedProfileNoRecommendations: "Este usuario aún no ha compartido recomendaciones.",
    visitedProfileNoPublicComments: "Este usuario aún no ha compartido comentarios públicos.",
    visitedProfileNoRatings: "Este usuario aún no tiene calificaciones.",
    visitedProfileNoSocialActivity: "Este usuario aún no tiene actividad social visible.",
    profileFeedSelectFavoriteProduction: "Selecciona una película para este espacio.",
    favoriteProductionComingSoon: "Próximamente",
    ...
    contactDescription: "RecCool es una red social para descubrir, calificar y compartir películas y series, conectar con otros usuarios y encontrar nuevas producciones a partir de recomendaciones y experiencias de la comunidad. Este espacio también está disponible para que puedas ponerte en contacto con nosotros y compartir de manera respetuosa tus consultas, comentarios, peticiones y sugerencias, las cuales serán recibidas y analizadas por nuestro equipo.",
    contactCategory: "Categoría",
    contactCategoryPlaceholder: "Selecciona una categoría",
    contactTechnical: "Servicio técnico",
    contactCommercial: "Comercial",
    contactRequestsSuggestions: "Peticiones y sugerencias",
    contactSubject: "Asunto",
    contactMessage: "Mensaje",
    contactSend: "Enviar",
    contactSending: "Enviando...",
    contactSuccess: "Tu mensaje fue enviado correctamente.",
    contactError: "No fue posible enviar tu mensaje en este momento. Inténtalo nuevamente más tarde.",
    contactCategoryRequired: "Selecciona una categoría.",
    contactSubjectRequired: "Ingresa un asunto.",
  ...
  en: {
    ...
    guestRate: "Sign up to rate",
    guestSeeMorePrefix: "To see more,",
    guestRatePrefix: "To rate,",
    guestListPrefix: "To add to your list,",
    guestRecommendPrefix: "To Recommend,",
    guestExpandPrefix: "To view enlarged,",
    guestSignupPrefix: "",
    guestProfilePrefix: "To view your profile,",
    guestExploreProfilePrefix: "To explore your profile,",
    guestProfileLoginPrefix: "To view your profile,",
    guestExploreProfileLoginPrefix: "To explore your profile,",
    guestNotificationsPrefix: "To receive notifications,",
    guestAvailabilityPrefix: "To see availability in your country,",
    ...
    following: "Following",
    myRating: "My Rating",
    ratingPopoverTitle: "Rate Production",
    ratingPopoverLabel: "Your rating",
    noPoster: "No Poster",
    ...
    notificationReplyPlaceholder: "Reply to {username}…",
    notificationReplyButton: "Reply",
    notificationReplySending: "Sending…",
    notificationReplySent: "Reply sent",
    notificationReplyError: "The reply could not be sent.",
    ...
    trailerExternalOnly: "This trailer is only available on YouTube",
    trailerClose: "Close",
    ...
    movieDetailSeriesCommentTitle: "Comment on series",
    movieDetailVideoCommentTitle: "Video Reaction",
    movieDetailVideoCountSingular: "video",
    movieDetailVideoCountPlural: "videos",
    movieDetailTrailerCompanionEmpty: "Add your opinion to interact about this production",
    movieDetailVideoRecord: "Record",
    movieDetailVideoUpload: "Upload video",
    movieDetailVideoCancel: "Cancel",
    movieDetailVideoStop: "Stop",
    movieDetailVideoRetake: "Retake",
    movieDetailVideoSend: "Send",
    movieDetailVideoRecording: "Recording",
    movieDetailVideoRotatePortrait: "Rotate your phone to portrait to continue recording.",
    movieDetailVideoUploading: "Uploading",
    movieDetailVideoRequestingPermission: "Requesting permissions…",
    movieDetailVideoPermissionDenied: "Permission denied",
    movieDetailVideoCameraUnavailable: "Camera unavailable",
    movieDetailVideoMicrophoneUnavailable: "Microphone unavailable",
    movieDetailVideoUnsupportedBrowser: "Unsupported browser",
    movieDetailVideoInsecureContext: "HTTPS is required to record video",
    movieDetailVideoCameraBusy: "Camera is busy",
    movieDetailVideoUnknownError: "Unknown error",
    movieDetailVideoTooLong: "Video is too long",
    movieDetailVideoTooLarge: "Video is too large",
    movieDetailVideoUnsupportedFormat: "Unsupported format",
    movieDetailVideoEmpty: "No video comments yet.",
    movieDetailVideoLoadingVideos: "Loading videos…",
    movieDetailVideoLoadError: "Videos could not be loaded.",
    movieDetailVideoReactionError: "Your reaction could not be updated.",
    movieDetailVideoRetry: "Retry",
    movieDetailVideoDelete: "Delete video",
    movieDetailVideoPlay: "Play",
    movieDetailVideoPause: "Pause",
    movieDetailVideoSoundOn: "Turn sound on",
    movieDetailVideoMute: "Mute",
    movieDetailVideoRestart: "Restart",
    movieDetailVideoFullScreen: "Full screen",
    movieDetailVideoExpand: "Expand video",
    movieDetailVideoCloseExpanded: "Close",
    movieDetailVideoExpandedFeed: "Expanded videos",
    movieDetailVideoDeleteConfirm: "Do you want to delete this video?",
    movieDetailVideoDeleteAction: "Delete",
    movieDetailVideoDeleteError: "Video could not be deleted.",
    movieDetailVideoAuthError: "You must sign in to send the video",
    movieDetailVideoNetworkError: "Video could not be sent",
    movieDetailVideoServerError: "Server error",
    movieDetailVideoPermissionInfo: "QNext requires camera and microphone permissions so you can record your videos.",
    movieDetailVideoContinue: "Continue",
    movieDetailVideoCameraOpenError: "Could not open the camera.",
    movieDetailVideoPreviewPlaybackError: "Could not play the preview.",
    movieDetailVideoSelectedReadError: "Could not read the selected video.",
    movieDetailVideoLongerThan20Seconds: "The video exceeds 20 seconds.",
    movieDetailVideoFileTooLarge50Mb: "The video exceeds 50 MB.",
    movieDetailVideoCameraAccessError: "Could not access the camera and microphone.",
    movieDetailVideoRecorderStartError: "Could not start recording.",
    movieDetailVideoCameraPreviewError: "Could not show the camera.",
    movieDetailVideoPreparingCamera: "Preparing camera…",
    movieDetailVideoReadingSelectedFile: "Reading video…",
    movieDetailVideoRecordedCreateError: "The recorded video could not be created. Please try again.",
    movieDetailVideoPreparingPreview: "Preparing preview…",
    movieDetailVideoPreviewTimeout: "The video preview could not be prepared.",
    ...
    movieDetailPublicCommentCountSingular: "comment",
    movieDetailPublicCommentCountPlural: "comments",
    ...
    movieDetailSearchUser: "Search user",
    movieDetailHasComments: "Has comments",
    movieDetailHasConversation: "Has conversation",
    movieDetailNoComments: "No comments",
    movieDetailAll: "All",
    movieDetailNoDirectedComments: "There are no directed comments for this movie.",
    movieDetailNoDirectedCommentsWithUser: "No directed comments with this user.",
    movieDetailNoConversationMessages: "There are no messages in this conversation.",
    movieDetailDirectReplyPlaceholder: "Write a message...",
    ...
    movieDetailMyProfileAvatarLabel: "Go to my profile",
    profileFeedUser: "User",
    profileFeedPersonalDataAvatarLink: "Go to personal data",
    profileFeedAge: "{age} years old",
    profileFeedFavoriteMovies: "My Favorite Productions",
    ...
    profileFeedFollowingAndFriends: "Following/Friends",
    profileFeedFollowedByOne: "Has 1 follower",
    profileFeedFollowedByMany: "Has {count} followers",
    profileFeedFollowedByYouOne: "1 user follows you",
    profileFeedFollowedByYouMany: "{count} users follow you",
    ...
    profileFeedActions: "Actions",
    profileFeedRecordings: "Recordings",
    profileFeedNoRecordings: "No recordings from people you follow yet.",
    profileFeedFollowingActivityTitle: "Following Activity",
    profileFeedQuickNavigation: "Profile quick navigation",
    emptyFollowingTitle: "You are not following anyone yet.",
    emptyFollowingDescription: "Find and save public profiles of users whose tastes are similar to yours. You will be able to see their recommendations, public comments, ratings, and reactions, and discover productions you will probably love.",
    emptyFriendsTitle: "You have no friends added yet.",
    emptyFriendsDescription: "Add friends here. Even if you do not follow them, you can view their activity by visiting their profile. You can also send them direct messages by mentioning @username within the movie or series you want to discuss.",
    emptyMyActivityTitle: "You have no registered activity yet.",
    emptyMyActivityDescription: "Review your previous interactions: your public comments about movies or series and your reactions to comments from other users.",
    emptyInboxTitle: "No messages yet?",
    emptyInboxDescription: "Review your sent and received direct messages here, along with the movie or series where each conversation started.",
    emptyRatingsTitle: "You have not rated any productions yet.",
    emptyRatingsDescription: "Here you can review the ratings you have given to movies or series and return to each production to update your rating whenever you want.",
    emptyMyListTitle: "No productions to watch yet.",
    emptyMyListDescription: "Add the movies or series you plan to watch. Only you can see this list. Click the 🏷️ tag to save them and never forget them. Once you've watched them, remove them from the list... unless you'd like to watch them again 😉.",
    emptyMyRecommendationsTitle: "No productions to recommend yet.",
    emptyMyRecommendationsDescription: "Add movies or series you loved to this list by clicking the 🎟️ ticket. Your followers and friends will be able to see why you recommend them.",
    emptyFollowingRecommendationsDescription: "When the people you follow—and only the people you follow—recommend movies or series, you will find out about it here.",
    emptyFollowingActionsDescription: "When the people you follow—and only the people you follow—have public interactions, you will also see them here.",
    ...
    visitedProfileVideoReactions: "Video reactions",
    visitedProfileNoVideoReactions: "This user hasn't shared any video reactions yet.",
    visitedProfileVideoReactionsError: "This user's video reactions could not be loaded.",
    visitedProfilePreviousVideoReaction: "Previous video reaction",
    visitedProfileNextVideoReaction: "Next video reaction",
    visitedProfilePublicComments: "Public Comments",
    visitedProfileRatings: "Ratings",
    visitedProfileLikesDislikes: "Likes/Dislikes",
    visitedProfileNoRecommendations: "This user has not shared any recommendations yet.",
    visitedProfileNoPublicComments: "This user has not shared any public comments yet.",
    visitedProfileNoRatings: "This user does not have any ratings yet.",
    visitedProfileNoSocialActivity: "This user does not have any visible social activity yet.",
    profileFeedSelectFavoriteProduction: "Select a movie for this slot.",
    favoriteProductionComingSoon: "Coming soon",
    ...
    contactDescription: "RecCool is a social network for discovering, rating, and sharing movies and series, connecting with other users, and finding new titles through community recommendations and experiences. You can also use this space to contact us and respectfully share your questions, comments, requests, and suggestions, which will be received and reviewed by our team.",
    contactCategory: "Category",
    contactCategoryPlaceholder: "Select a category",
    contactTechnical: "Technical Support",
    contactCommercial: "Commercial",
    contactRequestsSuggestions: "Requests and Suggestions",
    contactSubject: "Subject",
    contactMessage: "Message",
    contactSend: "Send",
    contactSending: "Sending...",
    contactSuccess: "Your message was sent successfully.",
    contactError: "We couldn't send your message right now. Please try again later.",
    contactCategoryRequired: "Select a category.",
