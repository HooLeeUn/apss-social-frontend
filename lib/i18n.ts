...
const translations = {
  es: {
    ...
    emptyMyListDescription: "Agrega las películas o series que tengas pendientes. Solo tú puedes ver esta lista. Haz clic en la etiqueta 🏷️ de cada producción para guardarla y no olvidarla. Cuando ya la hayas visto, elimínala de la lista, a menos que quieras repetirla 😉.",
    emptyMyRecommendationsTitle: "Sin producciones por recomendar.",
    emptyMyRecommendationsDescription: "Agrega a esta lista películas o series que te hayan encantado. Las personas que te siguen y tus amigos podrán ver por qué las recomiendas.",
  ...
  en: {
    ...
    emptyMyListDescription: "Add the movies or series you plan to watch. Only you can see this list. Select the 🏷️ tag on a production to save it and never forget it. Once you have watched it, remove it from the list—unless you want to watch it again 😉.",
    emptyMyRecommendationsTitle: "No productions to recommend yet.",
    emptyMyRecommendationsDescription: "Add movies or series you loved to this list. Your followers and friends will be able to see why you recommend them.",
