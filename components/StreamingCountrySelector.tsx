...
export default function StreamingCountrySelector({
  ...
  return (
    <div ref={containerRef} className={`relative flex ${iconOnly ? "max-w-[44px]" : "max-w-[88px]"} flex-col items-start gap-1 ${className}`}>
      ...
      {isOpen ? (
        <div className="absolute right-0 top-10 z-40 w-64 translate-x-8 md:translate-x-0 overflow-hidden rounded-xl border border-white/20 bg-zinc-900/98 p-1 shadow-[0_14px_26px_rgba(0,0,0,0.5)]">
          <input
            type="text"
            value={search}
