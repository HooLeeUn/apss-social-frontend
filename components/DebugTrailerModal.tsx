...
import { getTrailerDebugSnapshot, TRAILER_DEBUG, trailerDebugLog } from "../lib/trailerDebug";
...
export default function DebugTrailerModal({ movieId = null, movieTitle = null, interaction, ...props }: Props) {
  ...
  }, [props.error, props.externalOnly, props.loading, props.open, props.unavailable, props.trailerUrl, props.watchUrl]);
