        ...
        <div className={`${isFeed ? "min-w-0 space-y-1.5" : "space-y-2"} ${showExtendedMetadata ? "md:grid md:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] md:gap-6 md:space-y-0" : ""}`}>
          ...
          {isFeed && highlightMyRatingSlot && !showExtendedMetadata ? (
            <div
              ...
              aria-hidden="true"
            >
              <img src="/icons/tag.png" alt="" className="interaction-icon interaction-icon--compact interaction-icon--feed-sm" />
              <img src="/icons/Ticket.png" alt="" className="interaction-icon interaction-icon--compact interaction-icon--feed-sm" />
            </div>
          ) : null}
        </div>
        <div
          ...
          {isFeed ? (
            ...
            <div className="col-span-3 mt-1 flex justify-center" aria-hidden="true">
              <div className="interaction-icons">
                <img src="/icons/tag.png" alt="" className="interaction-icon interaction-icon--compact" />
                <img src="/icons/Ticket.png" alt="" className="interaction-icon interaction-icon--compact" />
              </div>
            </div>
          )}
        </div>
