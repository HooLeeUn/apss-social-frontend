...
export default function ProfileIdentityCard({
  ...
  const logoLinkClassName = isProfileFeedLogo ? "xl:mr-[88px] xl:flex-1" : "xl:min-w-[188px] xl:flex-initial";
  const logoClassName = isProfileFeedLogo
    ? "block h-auto max-h-[68px] min-w-0 w-full max-w-full object-contain object-left"
  ...
  return (
    <div className={cardClassName}>
      ...
      <div className="relative flex min-w-0 items-start justify-between gap-4">
        <Link
          href="/feed"
          className={`inline-flex min-h-[68px] min-w-0 flex-1 items-center justify-start overflow-hidden rounded-xl bg-transparent px-1 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-zinc-100 transition hover:text-blue-100 ${logoLinkClassName}`}
