...
export default function ProfileIdentityCard({
  ...
  const avatarClassName = `relative top-24 block h-20 w-20 shrink-0 overflow-hidden rounded-full border border-white/20 bg-zinc-800/90 [clip-path:circle(50%)] ${constrainDesktopAvatar ? "lg:absolute lg:right-1 lg:top-20 lg:h-[72px] lg:w-[72px]" : ""}`;
