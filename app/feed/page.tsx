    ...
    return (
      ...
      >
        ...
        <img
          src={defaultLogoUrl}
          alt="QNext"
          className="h-16 w-auto max-w-[min(46vw,190px)] origin-left object-contain object-left min-[360px]:scale-150 min-[375px]:scale-[1.6] sm:h-[4.5rem] sm:max-w-[220px] sm:scale-[1.65]"
          loading="eager"
          decoding="sync"
          fetchPriority="high"
...
export default function FeedPage() {
  ...
  return (
    <main className="feed-tablet-framing min-h-screen bg-black">
      ...
      <div className="feed-shell mx-auto w-full max-w-[1400px] space-y-14 px-4 pb-8 pt-0 md:px-8 xl:py-8">
