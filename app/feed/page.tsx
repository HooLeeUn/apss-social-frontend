    ...
    return (
      ...
      >
        ...
        <img
          src={defaultLogoUrl}
          alt="QNext"
          className="h-16 w-auto max-w-[min(46vw,190px)] origin-left object-contain object-left min-[360px]:scale-[1.15] min-[375px]:scale-[1.2] sm:h-[4.5rem] sm:max-w-[220px] sm:scale-125"
          loading="eager"
          decoding="sync"
          fetchPriority="high"
