                      ...
                      return (
                        <article
                          ...
                          className={`px-3 py-4 transition-colors ${
                            isExpanded
                              ? "rounded-xl border border-[#86ADE0]/30 border-l-4 border-l-[#86ADE0] bg-[#0b1f3a]/35 shadow-[0_0_24px_rgba(134,173,224,0.12)]"
                        ...
                        >
                          ...
                          {isExpanded ? (
                            <div
                              className="scrollbar-metallic-blue mt-3 max-h-[24rem] overflow-y-auto border-t border-[#86ADE0]/20 px-3 pt-3"
                              onScroll={(event) => {
